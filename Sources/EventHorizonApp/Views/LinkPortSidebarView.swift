...
public enum NavigationSection: String, CaseIterable, Identifiable, Sendable {
    ...
    public var iconName: String {
        ...
        case .starlink: return "globe.americas.fill"
...
public struct LinkPortSidebarView: View {
    ...
    private func safeLoadBlackholeLogo() -> NSImage? {
        ...
        let subBundlePath = (bundlePath as NSString).appendingPathComponent("Contents/Resources/UniversalWiFiManager_EventHorizonApp.bundle/blackhole_logo.jpg")
        ...
        if fileManager.fileExists(atPath: "Sources/EventHorizonApp/Resources/blackhole_logo.jpg") {
            return NSImage(contentsOfFile: "Sources/EventHorizonApp/Resources/blackhole_logo.jpg")
        }
